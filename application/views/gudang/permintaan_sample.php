                                            ...
                                            foreach ($formpermintaan as $fr) : ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center; width: 30%">
                                                        ...
                                                        <!-- <button type="button" class="btn bg-gradient-secondary" data-toggle="modal" data-target="#edit_data<?= $fr->form_id ?>" style="width: 83px;"><i class="fas fa-edit"></i>Edit</button> -->
                                                        <!-- <button type="button" class="btn bg-gradient-info" data-toggle="modal" data-target="#detail_data<?= $fr->form_id ?>" style="width: 83px;"><i class="fas fa-edit"></i>Detail</button> -->
                                                        <a href="<?= site_url('permintaansample/halamandetail/' . $fr->form_id) ?>"><button type="button" class="btn bg-gradient-info" style="width: 83px;"><i class="fas fa-file-invoice"></i>Detail</button></a>
