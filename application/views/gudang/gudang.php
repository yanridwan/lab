                                        ...
                                        <tbody>
                                            ...
                                            foreach ($gudangbarang as $data) : ?>
                                                <tr>
                                                    ...
                                                    <td style="color:white; <?php if ($data->gudang_qty <= 10) {
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Qty</label>
                                                <input type="number" class="form-control" id="qtyGudang" placeholder="Qty Gudang" name="gudangQty" value="<?= $br->gudang_qty ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Satuan</label>
                                                <input type="text" class="form-control" id="satuanGudang" placeholder="Satuan Gudang" name="gudangSatuan" value="<?= $br->gudang_satuan ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
