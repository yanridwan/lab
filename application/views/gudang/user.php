        ...
        <div class="modal fade" id="tambah_data">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" method="post" action="<?= site_url('User/tambah') ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <!-- <div class="form-group" style="display:inline-block;">
                                            ...
                                            <input class="form-control-file <?php echo form_error('nama') ? 'is-invalid' : '' ?>" type="file" name="gambar" value="<?php echo set_value('gambar'); ?>" />
                                        </div> -->
                                        <div class="form-group">
                                            <label>Email</label>
            ...
            <div class="modal fade" id="edit_data<?= $br->user_id ?>">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form class="form-horizontal" method="post" action="<?= site_url('user/ubah') ?>">
                            <div class="modal-body">
                                <!-- form start -->
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label>No. Telepon</label>
                                        <input type="text" class="form-control" placeholder="Nomor Telepon" name="no_telp" value="<?= $br->user_no_telp ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="email" class="form-control" placeholder="Email" name="email" value="<?= $br->user_email ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Tempat, Tanggal Lahir</label>
                                        <input type="text" class="form-control" placeholder="Tempat, Tanggal Lahir" name="ttl" value="<?= $br->user_tempat_tanggal_lahir ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>NIP</label>
