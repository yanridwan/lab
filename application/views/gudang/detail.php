...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            ?>
                                                                <pre style="display:table-row">[<?= $q->barang_kode ?>] <?= $q->barang_nama ?> (<?= $q->detail_komposisi_qty ?>)</pre>
                                                            <?php endforeach ?>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                ...
                                                                foreach ($q as $key => $value) {
                                                                    echo '[' . $value->barang_kode . '] ' . $value->barang_nama . ' (' . $value->revisi_komposisi_qty . ')<br>';
                                                                }
                                                                ?>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <?php if ($q[0]->status_id == "1") { ?>
                                                                    <button type="button" class="btn bg-gradient-primary" data-toggle="modal" data-target="#processrevisi" style="width: 83px;">Process</button>
                                                                <?php } elseif ($q[0]->status_id == '2') { ?>
                                                                    <button type="button" class="btn bg-gradient-success" data-toggle="modal" data-target="#finishrevisi" style="width: 83px;">Finish</button>
                                                                <?php } elseif ($q[0]->status_id == '3') { ?>
                                                                    <!-- <button type="button" class="btn bg-gradient-success" data-toggle="modal" data-target="#send" style="width: 83px;">Send</button> -->
                                                                    <form action="<?= site_url('detail/revisipengiriman/') ?>" method="POST">
                                                                        <input type="hidden" name="id" value="<?= $q[0]->form_id ?>">
                                                                        <button type="submit" class="btn bg-gradient-success" style="width: 83px;">Send</button>
                                                                    </form>
                                                                    <!-- <button type="button" class="btn bg-gradi
                                                                <?php } else { ?>
                                                                    <button type="button" class="btn bg-gradient-success" style="width: 83px;" disabled>Sent</button>
                                                                <?php } ?>
                                                            </td>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" method="post" action="<?= site_url('Detail/proses') ?>">
                        ...
                        <!-- <input type="hidden" value="<?= $form->form_id ?>" name="formId"> -->
        ...
        <div class="modal fade" id="processrevisi">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="col-md-12">
                    ...
                    <form class="form-horizontal" method="post" action="<?= site_url('Detail/prosesrevisi') ?>">
                        <!-- <input type="hidden" value="2" name="status"> -->
                        <input type="hidden" value="<?= $form->form_id; ?>" name="id" class="form-control">
                        <!-- <input type="hidden" value="<?= $form->form_id ?>" name="formId"> -->
                        <div class="modal-body">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="card-body table-responsive p-0" style="height: 300px;">
                                                <table class="table table-head-fixed text-nowrap table-striped">
                                                    ...
                                                    <tbody>
                                                        <?php $no = 1;
                                                        if (!empty($revisi)) foreach ($revisi as $q) :
                                                        ?>
                                                            <input type="hidden" value="<?= $q->form_id ?>" name="formId">
                                                            <tr>
                                                                <!-- <td>1</td> -->
