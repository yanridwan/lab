                                        ...
                                        <tbody>
                                            ...
                                            foreach ($dev as $data) : ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a href="<?= site_url('development/detailresearch/' . $data->development_id) ?>"><button type="button" class="btn bg-gradient-info" style="width: 83px;"><i class="fas fa-file-invoice"></i>Detail</button></a>
                                                        <!-- <button type="button" class="btn bg-gradient-warning" data-toggle="modal" data-target="#edit_data<?= $data->development_id ?>" style="width: 95px;"><i class="fas fa-chart-bar"></i>Analyze</button> -->
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Researcher</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" placeholder="Penanggung Jawab" name="researcher" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
