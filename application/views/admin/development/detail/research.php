...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <?php
                    $notif = $this->session->flashdata('sucess');
                    if (!empty($notif)) { ?>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="<?= site_url('development/research') ?>"><button type="button" class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" style="margin-right: 6px;"></i>Kembali</button></a>
                                    <div class="card-tools">
                                        <ul class="nav nav-pills ml-auto">
                                            <li class="nav-item">
                                                <button type="button" class="btn bg-gradient-warning btn-sm" data-toggle="modal" data-target="#analisa<?= $dev->development_id ?>" style="width: 95px;"><i class="fas fa-chart-bar"></i>Analyze</button>
        ...
        <div class="modal fade" id="analisa<?= $dev->development_id ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Analiysis</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form class="form-horizontal" method="post" action="<?= site_url('development/tambahanalysis') ?>" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?= $dev->development_id ?>">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="research" value="<?= $this->session->userdata('username') ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Analisa</label>
                                        <input type="text" class="form-control" placeholder="Analisa" name="analisa" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Hasil Analisa</label>
                                        <input type="text" class="form-control" placeholder="Hasil Analisa" name="hasil" required>
                                    </div>
                                    <div class="form-group">
        ...
        <?php $aa = 1;
        foreach ($analisis as $g) :
        ?>
            <div class="modal fade" id="update<?= $g->analisis_id ?>">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form class="form-horizontal" method="post" action="<?= site_url('development/updateanalysis') ?>" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?= $g->analisis_id ?>">
                            <input type="hidden" name="devid" value="<?= $g->development_id ?>">
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Researcher</label>
                                            <input type="text" class="form-control" name="research" value="<?= $g->analisis_research ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Tanggal Mulai</label>
                                            <input type="date" class="form-control" name="tanggalmulai" value="<?= date('Y-m-d', strtotime($g->analisis_tanggal_mulai)) ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Tanggal Selesai</label>
                                            <input type="date" class="form-control" name="tanggalselesai" value="<?= date('Y-m-d', strtotime($g->analisis_tanggal_selesai)) ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Analisa</label>
                                            <input type="text" class="form-control" placeholder="Analisa" value="<?= $g->analisis_analisa ?>" name="analisa" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label>Hasil Analisa</label>
                                            <input type="text" class="form-control" placeholder="Hasil Analisa" value="<?= $g->analisis_hasil ?>" name="hasil" required>
                                        </div>
                                        <!-- <div class="form-group">
                                            <label for="exampleInputFile">File input</label>
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="exampleInputFile" name="dokumen" value="<?= $g->analisis_dokumen ?>">
                                                    <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                                                </div>
                                                <div class="input-group-append">
                                                    <span class="input-group-text">Upload</span>
        ...
        <?php $aa = 1;
        foreach ($analisisDokumen as $g) :
        ?>
            <div class="modal fade" id="attach<?= $g['analisis_id'] ?>">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Update </h4>
                        ...
                        <form class="form-horizontal" method="post" action="<?= site_url('development/attach') ?>" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?= $g['analisis_id'] ?>">
                            <input type="hidden" name="devid" value="<?= $g['development_id'] ?>">
                            <div class="modal-body">
                                <div class="row">
