                                            ...
                                            foreach ($formpermintaan as $fr) : ?>
                                                <tr>
                                                    <form class="form-horizontal" method="post" action="<?= site_url('permintaansample/finish') ?>">
                                                        ...
                                                        <td style="text-align: center;">
                                                            <a href="<?= site_url('detail/marketing/' . $fr->form_id) ?>"><button type="button" class="btn bg-gradient-info" style="width: 83px;"><i class="fas fa-file-invoice"></i>Detail</button></a>
                                                            <?php if ($fr->form_hasil_akhir == "") { ?>
                                                                <?php if ($fr->status_id == '4') { ?>
                                                                    <button type="submit" class="btn bg-gradient-success" style="width: 83px;"><i class="fas fa-file-invoice"></i>Done</button>
        ...
        <div class="modal fade" id="tambah_data">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" method="post" action="<?= site_url('permintaansample/marketingtambah') ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" placeholder="Status" name="formStatus" value="Received" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control" placeholder="id project" name="formIdProject" value="<?= $form + 1 ?>" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" placeholder="Penanggung Jawab" value="<?= ucfirst($this->session->userdata('username')) ?>" name="formMarketing" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">APJ</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" placeholder="Penanggung Jawab" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
            ...
            <div class="modal fade" id="revisi_data<?= $fr->form_id ?>">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <form class="form-horizontal" method="post" action="<?= site_url('permintaansample/marketingrevisi') ?>">
                            <div class="card-body">
